...
#define DRIVE_INFORMATION_PUBLISH_FREQUENCY    7   	/*!< Frequency in Hz to publish drive information */
...
#define MIN_ANGULAR_VELOCITY -1.75
#define MAX_ANGULAR_VELOCITY 1.75
